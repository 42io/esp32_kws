...
COMPONENT_ADD_INCLUDEDIRS += esp_adf/components/esp-sr/acoustic_algorithm/include
COMPONENT_ADD_LDFLAGS     += -L$(COMPONENT_PATH)/esp_adf/components/esp-sr/acoustic_algorithm -lesp_audio_processor
